    ...
    <nav className={`navbar ${navbarStyles.navbarTop}`} role="navigation" aria-label="dropdown navigation">
        <div className={`container ${navbarStyles.navContainer}`}>
            ...
            <div className="navbar-start">
                ...
                <Link className={`navbar-item ${navbarStyles.navbarItemParent}`} to="/shop">
                    Shop
                </Link>
                <Link className={`navbar-item ${navbarStyles.navbarItemParent}`} to="/why-malawi">
                    Why malawi?
                </Link>
                <div className="navbar-item has-dropdown is-hoverable">
                    <Link className={`navbar-link ${navbarStyles.navbarItemParent}`} to="/projects">
                        Projects
                    </Link>
                ...
                <div className="navbar-item has-dropdown is-hoverable">
                    <Link className={`navbar-link ${navbarStyles.navbarItemParent}`} to="/get-involved">
                        Get involved
                    </Link>
                    <div className="navbar-dropdown">
                        <Link className="navbar-item" to="/projects/sams-village">
                ...
                <div className="navbar-item has-dropdown is-hoverable">
                    <Link className={`navbar-link ${navbarStyles.navbarItemParent}`} to="/about-us">
                        About us
                    </Link>
                    <div className="navbar-dropdown">
